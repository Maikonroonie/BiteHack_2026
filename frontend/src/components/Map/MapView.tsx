...
function DrawControl({ onBoundsSelect }: { onBoundsSelect: (bbox: BoundingBox) => void }) {
    const map = useMap();
...
function MapPosition({ onMoveEnd }: { onMoveEnd: (center: [number, number], zoom: number) => void }) {
