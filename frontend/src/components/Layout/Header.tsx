            ...
            <div className="h-full flex items-center justify-between px-6">
                ...
                <div className="flex items-center gap-6">
                    ...
                    {isAnalyzing && (
                        ...
                        >
                            <motion.div
                                ...
                                transition={{ duration: 1, repeat: Infinity }}
                            />
                            <span className="text-sm text-cyber-cyan font-medium">Analyzing...</span>
                        </motion.div>
                    )}
                    ...
                    <div className="flex items-center gap-2">
                        <Activity
                            className={`w-4 h-4 ${isConnected ? 'text-cyber-green' : 'text-cyber-red'}`}
                        />
                    ...
                    <motion.button
                        className="relative p-2 hover:bg-orbital-surface rounded-lg transition-colors"
